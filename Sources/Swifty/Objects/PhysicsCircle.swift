...
public class PhysicsCircle: Circle, Physical {
    ...
    override var type: Types { .PhysicsCircle }
    ...
    override public init(radius: CGFloat) {
        super.init(radius: radius)
        physics = SKPhysicsBody.init(circleOfRadius: radius)
        updateValues()
    }
